...
import com.mgnt.userservice.event.EventProducer;
...
//    private final UserInterface userInterface;
    ...
    public ResponseEntity<String> sendMessage() {
        ...
        // Send the message to the "hello" topic
        eventProducer.sendEvent("hello", message);
     ...
     */
    @GetMapping("/mypage")
    public ApiResult<GetUserResponse> getUserDetail(
