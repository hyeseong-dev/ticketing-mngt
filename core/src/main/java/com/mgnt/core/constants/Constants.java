...
public class Constants {
    ...
    public static final String TOPIC_RESERVATIONS_CREATED = "reservations-created";
    ...
    // redis
    public static final String RESERVATION_LOCK_PREFIX = "reservation:lock:";
    public static final String RESERVATION_INVENTORY_TOPIC = "reservation-inventory-requests";
    public static final String RESERVATION_INVENTORY_LOCK_PREFIX = "reservation-inventory:lock:";
    public static final long LOCK_WAIT_TIME = 5;
    public static final long LOCK_LEASE_TIME = 10;
    public static final Long TEMP_RESERVATION_MINUTES = 5L; // 5분
